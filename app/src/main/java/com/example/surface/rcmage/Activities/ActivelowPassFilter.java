...
public class ActivelowPassFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               ...
               // Toast.makeText(ActivelowPassFilter.this,C + " "+I.getResistor()+ "", Toast.LENGTH_SHORT).show();
    ...
    public void clicka(View view) {
        switch (view.getId()) {
            case (R.id.imageButton_ALPF):
                AlertDialog.Builder dialog = new AlertDialog.Builder(ActivelowPassFilter.this);
            ...
            case (R.id.button_ALPF_GO):
                AlertDialog.Builder dialog3 = new AlertDialog.Builder(ActivelowPassFilter.this);
                ...
                dialog3.setPositiveButton("Set Gain", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (!editGain.getText().toString().equals("")) {
...
//                        gainView.setText("Gain: " + format.format(gain));
                ...
                dialog3.setNegativeButton("Set Frequency", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (!editFreq.getText().toString().equals("")) {
            ...
            case (R.id.button_ALPF_Load_Capacitor):
                AlertDialog.Builder dialog1 = new AlertDialog.Builder(ActivelowPassFilter.this);
                ...
                dialog1.setItems(charListCap, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        currentValueCapList = setCapacitorList();
                        Toast.makeText(ActivelowPassFilter.this, "The Capacitor Set Is " + currentLoadedCap + " " + currentValueCapList.size(), Toast.LENGTH_SHORT).show();
                        List<String> CapArray = new ArrayList<>();
                        for (int i = 0; i < currentValueCapList.size(); ++i) {
                            Symbol s1 = new Symbol("Capacitor");
                            String s = s1.numberToSymbol(currentValueCapList.get(i).getCapacitor());
                        ...
                        ArrayAdapter<String> CapAdapter = new ArrayAdapter<String>(ActivelowPassFilter.this, R.layout.spinner_item_main_activity, CapArray);
                        CapAdapter.setDropDownViewResource(R.layout.spinner_item_main_activity);
                        Cspinner.setAdapter(CapAdapter);
                        dialog.dismiss();
                    }
            ...
            case (R.id.button_ALPF_Load_Resistor):
                AlertDialog.Builder dialog2 = new AlertDialog.Builder(ActivelowPassFilter.this);
                ...
                dialog2.setItems(charListRes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ArrayAdapter<String> ResAdapter = new ArrayAdapter<String>(ActivelowPassFilter.this, R.layout.spinner_item_main_activity, ResistoArray);
                        ResAdapter.setDropDownViewResource(R.layout.spinner_item_main_activity);
                        Rspinner.setAdapter(ResAdapter);
                        R1spinner.setAdapter(ResAdapter);
                        R2spinner.setAdapter(ResAdapter);
                        Toast.makeText(ActivelowPassFilter.this, "The Resistor Set Is " + currentLoadedRes + " " + currentValueResList.size(), Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
                dialog2.show();
